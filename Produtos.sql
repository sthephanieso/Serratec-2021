...
VALUES ('S858G', 'Samsung Galaxy S21','Um smartphone Android com características inovadoras que o tornam uma excelente opção para qualquer tipo de utilização.', 5399.10, 'Celular', 5, 15, 40),
		...
		('P594E', 'Playstation 5','Domine o poder de uma CPU e GPU personalizadas e o SSD com E/S integradas que redefinem as regras do que o console Playstation pode fazer.', 7299.99, 'Consoles', 5, 15, 40),
